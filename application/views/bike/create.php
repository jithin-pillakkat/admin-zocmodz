    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading"> ADD BIKE <a href="<?= base_url('bike') ?>" class="btn btn-default pull-right">BACK</a></div>
                    ...
                    <div class="panel-body">
                        <form action="<?= base_url('bike/store') ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="form-actions">
                                ...
                                <a href="<?= base_url('bike/create')?>" class="btn btn-default">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
