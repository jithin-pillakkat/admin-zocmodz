<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-30">Bike <a href="<?= base_url('bike/create') ?>" class="btn btn-info pull-right">ADD</a></h3>
...
<script>
    $(function() {
        ...
        $("#dataTable tbody").on('change', '.changeStatus', function() {
            ...
            $.ajax({
                method: "GET",
                url: "<?= base_url('bike/changeStatus') ?>",
                dataType: 'json',
                data: {
                    id: id,
                    status: status
